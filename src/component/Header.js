...
return (
        ...
        <div className='headerLeft d-flex align-center'>
          <img width={40} heigth={40} src="/img/logo.jfif" alt='logo' />
          <div className='headerInfo'>
            <h3 className="text-uppercase">REACT suits</h3>
            <p>Магазин лучших костюмов</p>
          </div>
        </div>
        </Link>
  
        <ul className='headerRight d-flex '>
        <li onClick={props.onClickCart} className="d-flex vremenno-li cu-p">
...
{/* пока header класс не имеет поэтому добавил временную */}
        <li>
          <Link to={'/favorites'}>
            <img className='heart-class' src="/img/heart.png" alt="" />
          </Link>
          </li>
        {/* <li>
